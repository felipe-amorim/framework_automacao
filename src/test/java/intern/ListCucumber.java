...
import static produtos.net.config.SDNetConfig.inicioLimpoDeVm;
...
public class ListCucumber implements ConcurrentEventListener {
    ...
    private final EventHandler<TestCaseStarted> testCaseStartedHandler = new EventHandler<TestCaseStarted>() {
        ...
        public void receive(TestCaseStarted event) {
            ...
            String raizProduto = relativePath.split("produtos/")[1];


            //System.out.println("RAIZ PRODUTO: "+raizProduto);
            /*if(!raizProduto.contains("_desenv")){
            ...
            //}
            if(event.testCase.getUri().contains("net/sms/desktop")){
                //Instances.commandEx("taskkill -f -im teamviewer.exe");
                inicioLimpoDeVm();
            }
        }
    };
